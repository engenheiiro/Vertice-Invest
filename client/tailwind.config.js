...
'shake': 'shake 0.4s cubic-bezier(.36,.07,.19,.97) both',
        ...
        // `animate-tour-glow` (spotlight do tutorial) NÃO mora aqui de propósito:
        // está em index.css. Keyframe declarado no config só entra no CSS quando o
        // dev server reinicia — quem estivesse com `npm run dev` aberto recebia o
        // JS novo por HMR e o CSS velho, e o destaque sumia sem erro nenhum.
      },
      keyframes: {
        pulseSlow: {
          '0%, 100%': { opacity: '0.4' },
