...
//   Exterior   (STOCK_US)     → STOCK | REIT | DOLLAR  (ETFs viraram classe própria)
//
...
export const SUB_LABELS: { FIXED_INCOME: Record<FixedIncomeSubKey, string>; STOCK_US: Record<UsSubKey, string> } = {
