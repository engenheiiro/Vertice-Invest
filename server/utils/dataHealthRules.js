...
const macroChecks = (facts, th) => {
    ...
    out.push(check({
        ...
        hint: 'macroDataService.updateCurrencies — cadeia Yahoo → AwesomeAPI, a cada 15 min. Câmbio parado congela a conversão de toda posição dolarizada, não só a barra de indicadores.',
    }));
