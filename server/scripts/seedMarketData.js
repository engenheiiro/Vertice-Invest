...
const assets = [
    // --- AÇÕES BR ---
    { ticker: 'VALE3', name: 'Vale', type: 'STOCK', sector: 'Materiais Básicos' },
    ...
    { ticker: 'ABEV3', name: 'Ambev', type: 'STOCK', sector: 'Consumo não Cíclico' },
    { ticker: 'ITSA4', name: 'Itaúsa', type: 'STOCK', sector: 'Holding Financeira' }, // CORRIGIDO
    { ticker: 'RENT3', name: 'Localiza', type: 'STOCK', sector: 'Consumo Cíclico' },
    { ticker: 'BPAC11', name: 'BTG Pactual', type: 'STOCK', sector: 'Financeiro' },
    { ticker: 'GGBR4', name: 'Gerdau', type: 'STOCK', sector: 'Materiais Básicos' },
    { ticker: 'SUZB3', name: 'Suzano', type: 'STOCK', sector: 'Materiais Básicos' },
    { ticker: 'PRIO3', name: 'Prio', type: 'STOCK', sector: 'Petróleo e Gás' },
    { ticker: 'RDOR3', name: 'Rede D\'Or', type: 'STOCK', sector: 'Saúde' },
    { ticker: 'RAIL3', name: 'Rumo', type: 'STOCK', sector: 'Bens Industriais' },
    { ticker: 'VIVT3', name: 'Telefônica Brasil', type: 'STOCK', sector: 'Telecomunicações' },
    { ticker: 'TIMS3', name: 'TIM', type: 'STOCK', sector: 'Telecomunicações' },
    { ticker: 'BBSE3', name: 'BB Seguridade', type: 'STOCK', sector: 'Seguros' },
    { ticker: 'CXSE3', name: 'Caixa Seguridade', type: 'STOCK', sector: 'Seguros' },
    { ticker: 'CMIG4', name: 'Cemig', type: 'STOCK', sector: 'Utilidade Pública' },
    { ticker: 'EGIE3', name: 'Engie Brasil', type: 'STOCK', sector: 'Utilidade Pública' },
    { ticker: 'TAEE11', name: 'Taesa', type: 'STOCK', sector: 'Utilidade Pública' },
    { ticker: 'KLBN11', name: 'Klabin', type: 'STOCK', sector: 'Materiais Básicos' },
    { ticker: 'SANB11', name: 'Santander BR', type: 'STOCK', sector: 'Financeiro' },
    { ticker: 'CSAN3', name: 'Cosan', type: 'STOCK', sector: 'Infraestrutura e Energia' }, // CORRIGIDO
    { ticker: 'LREN3', name: 'Lojas Renner', type: 'STOCK', sector: 'Consumo Cíclico' },
    { ticker: 'MGLU3', name: 'Magalu', type: 'STOCK', sector: 'Consumo Cíclico' },
    { ticker: 'HAPV3', name: 'Hapvida', type: 'STOCK', sector: 'Saúde' },
    { ticker: 'EQTL3', name: 'Equatorial', type: 'STOCK', sector: 'Utilidade Pública' },
    { ticker: 'RADL3', name: 'Raia Drogasil', type: 'STOCK', sector: 'Consumo não Cíclico' }, // CORRIGIDO
    { ticker: 'UGPA3', name: 'Ultrapar', type: 'STOCK', sector: 'Distribuição Combustíveis' }, // CORRIGIDO
    { ticker: 'CSNA3', name: 'CSN Siderúrgica', type: 'STOCK', sector: 'Materiais Básicos' },
    { ticker: 'GOAU4', name: 'Metalúrgica Gerdau', type: 'STOCK', sector: 'Materiais Básicos' },
    { ticker: 'ENEV3', name: 'Eneva', type: 'STOCK', sector: 'Energia' }, // CORRIGIDO
    { ticker: 'VBBR3', name: 'Vibra Energia', type: 'STOCK', sector: 'Distribuição Combustíveis' },
    { ticker: 'HYPE3', name: 'Hypera Pharma', type: 'STOCK', sector: 'Saúde' },
    { ticker: 'CYRE3', name: 'Cyrela', type: 'STOCK', sector: 'Consumo Cíclico' },
    { ticker: 'TOTS3', name: 'Totvs', type: 'STOCK', sector: 'Tecnologia' },
    { ticker: 'SESP4', name: 'Sanepar', type: 'STOCK', sector: 'Utilidade Pública' },
    { ticker: 'SAPR11', name: 'Sanepar Unit', type: 'STOCK', sector: 'Utilidade Pública' },
    { ticker: 'CPFE3', name: 'CPFL Energia', type: 'STOCK', sector: 'Utilidade Pública' },
    { ticker: 'FLRY3', name: 'Fleury', type: 'STOCK', sector: 'Saúde' },
    { ticker: 'MRFG3', name: 'Marfrig', type: 'STOCK', sector: 'Consumo não Cíclico' },
    { ticker: 'BEEF3', name: 'Minerva', type: 'STOCK', sector: 'Consumo não Cíclico' },
    { ticker: 'ALPA4', name: 'Alpargatas', type: 'STOCK', sector: 'Consumo Cíclico' },
    { ticker: 'VAMO3', name: 'Vamos', type: 'STOCK', sector: 'Bens Industriais' },
    { ticker: 'ASAI3', name: 'Assaí', type: 'STOCK', sector: 'Consumo não Cíclico' },

    // --- FIIs (Classificação Imobiliária Estrita) ---
    { ticker: 'HGLG11', name: 'CSHG Logística', type: 'FII', sector: 'Logístico' },
    { ticker: 'KNRI11', name: 'Kinea Renda', type: 'FII', sector: 'Híbrido' },
    { ticker: 'MXRF11', name: 'Maxi Renda', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'XPML11', name: 'XP Malls', type: 'FII', sector: 'Shopping' },
    { ticker: 'VISC11', name: 'Vinci Shopping', type: 'FII', sector: 'Shopping' },
    { ticker: 'XPLG11', name: 'XP Logística', type: 'FII', sector: 'Logístico' },
    { ticker: 'HGBS11', name: 'Hedge Brasil Shopping', type: 'FII', sector: 'Shopping' },
    { ticker: 'HGRU11', name: 'CSHG Renda Urbana', type: 'FII', sector: 'Renda Urbana' },
    { ticker: 'BTLG11', name: 'BTG Pactual Logística', type: 'FII', sector: 'Logístico' },
    { ticker: 'KNIP11', name: 'Kinea Índices', type: 'FII', sector: 'Papel/CRI' },
    ...
    { ticker: 'RECR11', name: 'Rec Recebíveis', type: 'FII', sector: 'Papel/CRI' },
    ...
    { ticker: 'ALZR11', name: 'Alianza Trust', type: 'FII', sector: 'Híbrido' },
    { ticker: 'VILG11', name: 'Vinci Logística', type: 'FII', sector: 'Logístico' },
    { ticker: 'HFOF11', name: 'Hedge Top FOF', type: 'FII', sector: 'Híbrido' },
    { ticker: 'BRCO11', name: 'Bresco Logística', type: 'FII', sector: 'Logístico' },
    { ticker: 'HGCR11', name: 'CSHG Recebíveis', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'KNSC11', name: 'Kinea Securities', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'HSML11', name: 'HSI Malls', type: 'FII', sector: 'Shopping' },
    { ticker: 'LVBI11', name: 'VBI Logística', type: 'FII', sector: 'Logístico' },
    ...
    { ticker: 'RBRR11', name: 'RBR Rendimento', type: 'FII', sector: 'Papel/CRI' },
    ...
    { ticker: 'GGRC11', name: 'GGR Covepi', type: 'FII', sector: 'Logístico' },
    { ticker: 'XPIN11', name: 'XP Industrial', type: 'FII', sector: 'Logístico' },
    { ticker: 'DEVA11', name: 'Devant Recebíveis', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'HCTR11', name: 'Hectare CE', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'VSLH11', name: 'Versalhes', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'TORD11', name: 'Tordesilhas', type: 'FII', sector: 'Híbrido' },
    { ticker: 'VGHF11', name: 'Valora Hedge', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'VGIR11', name: 'Valora RE', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'RBRF11', name: 'RBR Alpha', type: 'FII', sector: 'Híbrido' },
    { ticker: 'KFOF11', name: 'Kinea FOF', type: 'FII', sector: 'Híbrido' },
    { ticker: 'XPSF11', name: 'XP Selection', type: 'FII', sector: 'Híbrido' },
    { ticker: 'SNCI11', name: 'Suno Recebíveis', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'SNAG11', name: 'Suno Agro', type: 'FII', sector: 'Fiagro' }, // CORRIGIDO
    { ticker: 'VGIP11', name: 'Valora IP', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'CVBI11', name: 'VBI CRI', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'MCCI11', name: 'Mauá Capital', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'URPR11', name: 'Urca Prime', type: 'FII', sector: 'Papel/CRI' },
    { ticker: 'HABT11', name: 'Habitat', type: 'FII', sector: 'Papel/CRI' },
    ...
    { ticker: 'BRK-B', name: 'Berkshire Hathaway', type: 'STOCK_US', currency: 'USD', sector: 'Conglomerado' }, // CORRIGIDO
    { ticker: 'JPM', name: 'JPMorgan Chase', type: 'STOCK_US', currency: 'USD', sector: 'Financeiro' },
    { ticker: 'V', name: 'Visa Inc.', type: 'STOCK_US', currency: 'USD', sector: 'Meios de Pagamento' }, // CORRIGIDO
    ...
    { ticker: 'MA', name: 'Mastercard Inc', type: 'STOCK_US', currency: 'USD', sector: 'Meios de Pagamento' }, // CORRIGIDO
    ...
    { ticker: 'T', name: 'AT&T Inc', type: 'STOCK_US', currency: 'USD', sector: 'Comunicações' }, // CORRIGIDO
    { ticker: 'VZ', name: 'Verizon', type: 'STOCK_US', currency: 'USD', sector: 'Comunicações' }, // CORRIGIDO
