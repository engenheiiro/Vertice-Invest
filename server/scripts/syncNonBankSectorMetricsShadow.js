/**
 * Valida e sincroniza o snapshot oficial 1T26 de seguros/holdings em shadow.
...
for (const [issuer, payload] of Object.entries(NON_BANK_SECTOR_METRICS_1Q26)) {
  try {
...
const output = {
  ...
  expectedIssuers: Object.keys(NON_BANK_SECTOR_METRICS_1Q26).length,
